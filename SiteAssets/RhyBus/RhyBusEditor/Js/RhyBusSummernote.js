...
(function (global, factory) {
  ...
  var editable = renderer.create('<div class="note-editable description" contentEditable="true" role="textbox"  aria-multiline="true"/>');
  ...
  $$1.summernote = $$1.extend($$1.summernote, {
      ...
      options: {
          ...
          toolbar: [ 
              ...
              ['style', ['style']],
              ['font', ['bold', 'underline', 'italic', 'add-text-tags']],
              ['undo', ['undo']],
	          ['redo', ['redo']],
              ['horizontal rule', ['hr']],
